...
public final class PlayerViewModel_Factory implements Factory<PlayerViewModel> {
  ...
  public static PlayerViewModel_Factory create(
    ...
    return new PlayerViewModel_Factory(Providers.asDaggerProvider(savedStateHandleProvider), Providers.asDaggerProvider(playbackRepositoryProvider), Providers.asDaggerProvider(playerManagerProvider), Providers.asDaggerProvider(watchHistoryRepositoryProvider), Providers.asDaggerProvider(appSessionRepositoryProvider), Providers.asDaggerProvider(userSettingsRepositoryProvider), Providers.asDaggerProvider(catalogRepositoryProvider), Providers.asDaggerProvider(nextEpisodeResolverProvider), Providers.asDaggerProvider(episodeCatalogRepositoryProvider), Providers.asDaggerProvider(playbackSessionTrackerProvider), Providers.asDaggerProvider(appStringsProvider));
  }
  ...
  public static PlayerViewModel newInstance(SavedStateHandle savedStateHandle,
    ...
    return new PlayerViewModel(savedStateHandle, playbackRepository, playerManager, watchHistoryRepository, appSessionRepository, userSettingsRepository, catalogRepository, nextEpisodeResolver, episodeCatalogRepository, playbackSessionTracker, appStrings);
  }
}
